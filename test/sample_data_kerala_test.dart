...
void main() {
  ...
  test('Kerala sample temples parse visitor fields without dropping covers', () {
    for (final temple in kerala) {
  ...
  test('Kerala timings prefer official clocks over conflicting sample envelopes', () {
    ...
    expect(
      named('Sree Padmanabhaswamy Temple').timings,
      contains('SPST'),
    );
    expect(
